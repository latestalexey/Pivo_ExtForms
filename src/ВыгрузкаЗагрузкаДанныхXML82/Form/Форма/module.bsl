...
Процедура ОтключитьИспользованиеИтоговПриИзменении(Элемент)
...
Процедура УстановитьВидимость()
	...
	ЭлементыФормы.ОтключитьИтоги.Доступность = ОтключитьИспользованиеИтогов;
	ЭлементыФормы.ВключитьИтоги.Доступность = ОтключитьИспользованиеИтогов;
