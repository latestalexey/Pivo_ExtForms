...
//ZAM+++ 12.08.2015 #1190051 отчет по отмененным чекам
...
//ZAM+++ 12.08.2015 #1190051 отчет по отмененным чекам
						Если КодПричиныСтр="0" Тогда
							...
							НовОтмЧек.НомерСмены = НомерСмены;
							НовОтмЧек.НомерЧека  = НомерЧека;
							НовОтмЧек.Сумма      = Число(СтрПолучитьСтроку(ТекущаяСтрока, 12));
						КонецЕсли;
//ZAM--- 12.08.2015
