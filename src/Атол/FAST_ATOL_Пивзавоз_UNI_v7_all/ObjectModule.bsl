...
Функция СтрокаВыгрузкиТовара(ЗНАЧ Товар,Наименование,НаименованиеЭкран,ШтрихКоды, 
								...
								Кратность,ПЛУ,ВыгружатьГруппыПечати,СтрокаФлагов="0,1,1,0,1,0,0,1",НеДобиватьНулями=Ложь,НулевойОстаток)
	...
	+ ?(НулевойОстаток,"0",Формат(Товар.Остаток,"ЧГ="))										+	мРазделитель	// Остаток (6)
...
Функция ВыгрузитьТовары(Объект, Товары, УстановкаНовыхСчетчиков = Ложь) Экспорт
	...
	Для Каждого Товар Из Товары Цикл
		...
		"1"										+","+	// • продажа
		"1"										+","+	// • возврат
		?(Товар.Остаток>0,"0","1")				+","+	// • отрицательные остатки
		"1"										+","+	// • без ввода количества
		?(Товар.Остаток>0,"1","0")				+","+	// • списание остатков
		?(Товар.Цена = 0 
		ИЛИ 
		Товар.ЦенаНочь<>0 
		ИЛИ 
		...
		Строка=СтрокаВыгрузкиТовара(	Товар, _Наименование, _НаименованиеЭкран,
										...
										СтрокаФлагов,
										НеДобиватьНулями,НЕ УстановкаНовыхСчетчиков);
		Файл.ДобавитьСтроку(Строка);
	КонецЦикла;
