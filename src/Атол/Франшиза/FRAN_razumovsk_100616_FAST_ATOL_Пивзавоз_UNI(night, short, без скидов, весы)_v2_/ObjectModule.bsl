...
Функция ВыгрузитьТовары(Объект, Товары, ЧастичнаяВыгрузка = Ложь) Экспорт
	...
	Для Каждого Товар Из Товары Цикл
		...
		Сертификат=?(
		 СокрЛП(Товар.Номенклатура.Код) = "00000037807"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000037808"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000037809"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000037810"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000037812"
		,"10%",Сертификат);   //+svetl  повышенные бонусы

		
				
		//Сертификат=?(Товар.Номенклатура.ПринадлежитЭлементу(Справочники.Номенклатура.НайтиПоКоду("00000028794").Ссылка) 
		//ИЛИ Товар.Номенклатура.ПринадлежитЭлементу(Справочники.Номенклатура.НайтиПоКоду("00000033725").Ссылка) 
		//ИЛИ Товар.Номенклатура.ПринадлежитЭлементу(Справочники.Номенклатура.НайтиПоКоду("00000033394").Ссылка)
		//ИЛИ Товар.Номенклатура.ПринадлежитЭлементу(Справочники.Номенклатура.НайтиПоКоду("00000029225").Ссылка),"15%",Сертификат);   //+svetl  повышенные бонусы
