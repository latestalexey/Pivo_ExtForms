...
Функция ВыгрузитьТовары(Объект, Товары, ЧастичнаяВыгрузка = Ложь) Экспорт
	...
	Для Каждого Товар Из Товары Цикл
		...
		Сертификат=?(
		 СокрЛП(Товар.Номенклатура.Код) = "00000032992"
		...
		Сертификат=?(
		 СокрЛП(Товар.Номенклатура.Код) = "00000032991"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000028746"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000028750"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000033361"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000036519"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000029255"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000033728"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000028768"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000029171"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000029018"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000029732"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000029026"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000028784"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000033397"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000032981"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000032929"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000028820"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000028826"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000029038"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000034715"
		ИЛИ СокрЛП(Товар.Номенклатура.Код) = "00000029097"
		,"10%",Сертификат);   //+svetl  повышенные бонусы
