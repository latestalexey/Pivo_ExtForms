...
Функция ВыгрузитьТовары(Объект, Товары, ЧастичнаяВыгрузка = Ложь) Экспорт
	...
	Для Каждого Товар Из Товары Цикл
		...
		Пока Кат.Следующий() Цикл
			Если Кат.Категория = Справочники.КатегорииОбъектов.НайтиПоНаименованию("Без скидки(франшиза)") Тогда    //Не применять скидку в POS
				СоСкидкой = Ложь;
			КонецЕсли;
		КонецЦикла;
		...
		Если Товар.Номенклатура.ПринадлежитЭлементу(Справочники.номенклатура.НайтиПоКоду("00000000221")) Тогда 
			СоСкидкой = Ложь;   //делаем скидку на бутылки чтобы на них НЕ распространялись бонусы
		КонецЕсли;
		//+Svetl up
		...
		Иначе
			...
			//		_Кратность = "";
			//	ИначеЕсли Товар.Номенклатура.ПринадлежитЭлементу(Справочники.ИТИКонстанты.РазливноеПиво.Указатель) ИЛИ Товар.Номенклатура.ПринадлежитЭлементу(Справочники.ИТИКонстанты.РазливноеВино.Указатель) Тогда
			//		_Кратность = "0.5000";
			//	КонецЕсли
			//Иначе	 
		...
		Если ШтрихКоды.Количество()= 1 Тогда
			...
			// • редактирование цены
			// • ввод количества вручную
			+ ",1,1,0,1,0," + ?(Товар.Цена = 0, "1", "0") + ",1"   + мРазделитель
		...
		Иначе
			...
			+ ""                                                   + мРазделитель // Файл *.bmp с картинкой
			+ ""                                                   + мРазделитель // Описание
			+ _Кратность;                                                                 // Кратность количества
...
//выгрузить карты:
   Файл.ДобавитьСтроку("$$$ADDAUTODISCSCHMS");
   Файл.ДобавитьСтроку("1;Скидки на чек;Скидки на чек;4;");
  
   Файл.ДобавитьСтроку("$$$DELETEALLAUTODISCCONDS");

   Файл.ДобавитьСтроку("$$$ADDAUTODISCCONDS");
   //Файл.ДобавитьСтроку("1;700001;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;00001;12344;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;700002;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;12346;14999;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;700003;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;15000;19721;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;700004;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;19723;25000;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;700005;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;25050;35050;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;700006;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;35051;46000;;;;;;;;;;;;;;;1;5;5;;");
   Файл.ДобавитьСтроку("1;700007;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;61000;61999;;;;;;;;;;;;;;;1;5;5;;");
   Файл.ДобавитьСтроку("1;700008;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;60000;60999;;;;;;;;;;;;;;;1;5;5;;");
   Файл.ДобавитьСтроку("1;700009;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;550000;554999;;;;;;;;;;;;;;;1;6;6;;");
   Файл.ДобавитьСтроку("1;700010;Скидка 5%;Скидка 5%;0;5;;;;;23:59:59;;;;;;;;;;;;;;530000;534999;;;;;;;;;;;;;;;1;6;6;;");
   
  // Файл.ДобавитьСтроку("1;800001;Скидка 3%;Скидка 3%;0;3;;;;;23:59:59;;;;;;;;;;;;;;12345;12345;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;900001;Скидка 10%;Скидка 10%;0;10;;;;;23:59:59;;;;;;;;;;;;;;90101;90101;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;1000001;Скидка 30%;Скидка 30%;0;30;;;;;23:59:59;;;;;;;;;;;;;;25001;25042;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;1000002;Скидка 30%;Скидка 30%;0;30;;;;;23:59:59;;;;;;;;;;;;;;90001;90100;;;;;;;;;;;;;;;1;5;5;;");
   //Файл.ДобавитьСтроку("1;1100001;Скидка 100%;Скидка 100%;0;100;;;;;23:59:59;;;;;;;;;;;;;;99998;99999;;;;;;;;;;;;;;;1;5;5;;");

   
    //Ночные цены
   Файл.ДобавитьСтроку("$$$ADDAUTODISCSCHMS");
   Файл.ДобавитьСтроку("2;Товарные скидки;Товарные скидки;4;");
   Файл.ДобавитьСтроку("$$$ADDAUTODISCCONDS");
   Файл.ДобавитьСтроку("2;100001;+10% 23.00-00.00;+10% 23.00-00.00;2;10;;;;23:00:00;23:59:59;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;0;;;;");
   Файл.ДобавитьСтроку("2;200001;+10% 00.01-08.59;+10% 00.01-08.59;2;10;;;;0:00:01;8:59:59;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;0;;;;");
   Файл.ДобавитьСтроку("$$$ADDWARESPARAMS");
   Файл.ДобавитьСтроку("10259;2;;;;;;;;;");
   Файл.ДобавитьСтроку("6983;2;;;;;;;;;");
   Файл.ДобавитьСтроку("7248;2;;;;;;;;;");
   Файл.ДобавитьСтроку("7360;2;;;;;;;;;");
   Файл.ДобавитьСтроку("6982;2;;;;;;;;;");
   Файл.ДобавитьСтроку("2670;2;;;;;;;;;");
   Файл.ДобавитьСтроку("83;2;;;;;;;;;");
   Файл.ДобавитьСтроку("7;2;;;;;;;;;");
   Файл.ДобавитьСтроку("10;2;;;;;;;;;");
   Файл.ДобавитьСтроку("16;2;;;;;;;;;");
   Файл.ДобавитьСтроку("7639;2;;;;;;;;;");
   Файл.ДобавитьСтроку("2666;2;;;;;;;;;");
   Файл.ДобавитьСтроку("23;2;;;;;;;;;");
   Файл.ДобавитьСтроку("3086;2;;;;;;;;;");
   Файл.ДобавитьСтроку("3172;2;;;;;;;;;");
   Файл.ДобавитьСтроку("3159;2;;;;;;;;;");
   Файл.ДобавитьСтроку("3212;2;;;;;;;;;");
   Файл.ДобавитьСтроку("3173;2;;;;;;;;;");
   Файл.ДобавитьСтроку("9802;2;;;;;;;;;");
   Файл.ДобавитьСтроку("9893;2;;;;;;;;;");
   Файл.ДобавитьСтроку("9797;2;;;;;;;;;");
   Файл.ДобавитьСтроку("63;2;;;;;;;;;");
   Файл.ДобавитьСтроку("2874;2;;;;;;;;;");
   Файл.ДобавитьСтроку("2485;2;;;;;;;;;");
	Файл.ДобавитьСтроку("2486;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5384;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("10949;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5152;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5383;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5265;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5278;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5382;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5233;2;;;;;;;;;");
//	Файл.ДобавитьСтроку("5266;2;;;;;;;;;");
	Файл.ДобавитьСтроку("10678;2;;;;;;;;;");   
	//19.11.14
	Файл.ДобавитьСтроку("12606;2;;;;;;;;;");
	Файл.ДобавитьСтроку("6985;2;;;;;;;;;");
	Файл.ДобавитьСтроку("3649;2;;;;;;;;;"); 
	//04.12.14
	Файл.ДобавитьСтроку("12606;2;;;;;;;;;");
    Файл.ДобавитьСтроку("10789;2;;;;;;;;;");
	Файл.ДобавитьСтроку("10790;2;;;;;;;;;");
     //01.01.15
	Файл.ДобавитьСтроку("12604;2;;;;;;;;;");
    Файл.ДобавитьСтроку("11912;2;;;;;;;;;");
      //23.04.15
	Файл.ДобавитьСтроку("29576;2;;;;;;;;;");
    Файл.ДобавитьСтроку("28634;2;;;;;;;;;");
     //30.10.15
	Файл.ДобавитьСтроку("32236;2;;;;;;;;;");
	Файл.ДобавитьСтроку("28829;2;;;;;;;;;");
	Файл.ДобавитьСтроку("28830;2;;;;;;;;;");
	Файл.ДобавитьСтроку("28832;2;;;;;;;;;");
	Файл.ДобавитьСтроку("28833;2;;;;;;;;;");
	Файл.ДобавитьСтроку("28834;2;;;;;;;;;");
	Файл.ДобавитьСтроку("12602;2;;;;;;;;;");  //рудненское
	Файл.ДобавитьСтроку("3476;2;;;;;;;;;"); //ижевское живое
	Файл.ДобавитьСтроку("32447;2;;;;;;;;;"); //немецкое светлое
	Файл.ДобавитьСтроку("11802;2;;;;;;;;;");        //     ИРЛАНДСКИЙ ЭЛЬ , темное 16% Кожевниково 50л 
	Файл.ДобавитьСтроку("28262;2;;;;;;;;;");       //Ячменный бочонок Нижний Тагил  50л
	Файл.ДобавитьСтроку("3541;2;;;;;;;;;");       //Мюнкер  темное карамельное 50л МАГ
	Файл.ДобавитьСтроку("33163;2;;;;;;;;;");      //Акция Немецкое св. хол. охмеления  2+1 Груша
	Файл.ДобавитьСтроку("32833;2;;;;;;;;;");   //               Акция Немецкое св. хол. охмеления 2+1 барбарис
	Файл.ДобавитьСтроку("30594;2;;;;;;;;;");   //Акция Немецкое св.хол.охлаждения 2+1 лимонад
	
 	//11.11.15
	Файл.ДобавитьСтроку("12602;2;;;;;;;;;");    //Рудненское светлое Арасан 50л
	Файл.ДобавитьСтроку("32985;2;;;;;;;;;");   //Банное светлое паст. 11%, 50л
	Файл.ДобавитьСтроку("32989;2;;;;;;;;;");   //Банное светлое 1л с бутылкой
	Файл.ДобавитьСтроку("32990;2;;;;;;;;;");   //Банное светлое 1,5л с бутылкой
	Файл.ДобавитьСтроку("32991;2;;;;;;;;;");   //Банное светлое 2л с бутылкой
	Файл.ДобавитьСтроку("32992;2;;;;;;;;;");   //Банное светлое 3л с бутылкой
	Файл.ДобавитьСтроку("32994;2;;;;;;;;;");   //Банное светлое 4л с бутылкой
	Файл.ДобавитьСтроку("32236;2;;;;;;;;;");   //Рудненское светлое Арасан 0,5л с бутылкой
	Файл.ДобавитьСтроку("28829;2;;;;;;;;;");   //Рудненское светлое Арасан 1л с бутылкой
	Файл.ДобавитьСтроку("28830;2;;;;;;;;;");   //Рудненское светлое Арасан 1,5л с бутылкой
	Файл.ДобавитьСтроку("28832;2;;;;;;;;;");   //Рудненское светлое Арасан 2л с бутылкой
	Файл.ДобавитьСтроку("28833;2;;;;;;;;;");   //Рудненское светлое Арасан 3л с бутылкой
	Файл.ДобавитьСтроку("28834;2;;;;;;;;;");   //Рудненское светлое Арасан 4л с бутылкой

 
    //14.12.15
	Файл.ДобавитьСтроку("33560;2;;;;;;;;;");    //Виски-Кола Алкогольный 30л ПЭТ
	
	
	//12.01.16
	Файл.ДобавитьСтроку("34663;2;;;;;;;;;");
	Файл.ДобавитьСтроку("34661;2;;;;;;;;;");
	Файл.ДобавитьСтроку("33678;2;;;;;;;;;");
	Файл.ДобавитьСтроку("33555;2;;;;;;;;;");
	Файл.ДобавитьСтроку("33978;2;;;;;;;;;");
	Файл.ДобавитьСтроку("34246;2;;;;;;;;;");
	
	//19.01.16
	Файл.ДобавитьСтроку("34730;2;;;;;;;;;");

		
	Файл.ДобавитьСтроку("$$$ADDSETTINGS");
   	Файл.ДобавитьСтроку("InternalDefaultSchmRecID;1;");      
			...
			Если ТекущаяСтрока = "#" Тогда
				...
				Пока Не ПустаяСтрока(ТекущаяСтрока) Цикл
					...
					Если      ТипТранзакции =  1 Тогда
						...
						Результат = мОшибкаЗагрузкиОтчета;
						Прервать;
					ИначеЕсли      ТипТранзакции =  23 или ТипТранзакции =  24 Тогда
						// это транзакции работы с купюрами						
...
//Str-						
					...
					ИначеЕсли ТипТранзакции = 55 Тогда
						...
						Если СтрДлина(СокрЛП(ИнформацияПоСкидке))< 10 Тогда
