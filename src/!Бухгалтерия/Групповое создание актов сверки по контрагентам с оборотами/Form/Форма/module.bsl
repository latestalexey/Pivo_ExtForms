...
Процедура ПриОткрытии()
	Построитель.Текст="ВЫБРАТЬ
	                  ...
	                  |ИЗ
	                  |	РегистрБухгалтерии.Хозрасчетный.Обороты(&ДатаНачала, &ДатаКонца, , Счет В ИЕРАРХИИ (&СпСчетов), , {(Субконто1).* КАК Контрагент, (Субконто2).* КАК Договор,(Организация).* КАК Организация}, , ) КАК ХозрасчетныйОбороты
	                  |
	                  |УПОРЯДОЧИТЬ ПО
	                  |	ИмяКонтрагента
	                  |ИТОГИ ПО
