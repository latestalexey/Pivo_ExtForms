...
Процедура ПроверитьЗаполнениеРаздел1(ПараметрыВыгрузки, СтатусПроверки)
	...
	Для Каждого ЛистРаздела Из ДанныеРаздела Цикл
		...
		Если НомерЛиста = 1 Тогда
			...
			КонецЕсли;
			КоличЗаполненных = 0;
			ПроверитьЗаполнениеТаблицыРаздел1(СтатусПроверки, мИдГруппы11, ДанныеДопСтрок, ДополнительныеДанныеЛиста, НомерЛиста, СведенияОбОП, , КоличЗаполненных);
		...
		КонецЕсли;
		КоличЗаполненных = 0;
		ПроверитьЗаполнениеТаблицыРаздел1(СтатусПроверки, мИдГруппы12, ДанныеДопСтрок, ДополнительныеДанныеЛиста, НомерЛиста, СведенияОбОП, ЕстьЗаполненныйЛистРаздела, КоличЗаполненных);
...
Процедура ПроверитьЗаполнениеРаздел2(ПараметрыВыгрузки, СтатусПроверки)
	...
	Для Каждого ЛистРаздела Из ДанныеРаздела Цикл
		...
		Если НомерЛиста = 1 Тогда
			...
			КонецЕсли;
			КоличЗаполненных = 0;
			ПроверитьЗаполнениеТаблицыРаздел2(СтатусПроверки, мИдГруппы21, ДанныеДопСтрок, ДополнительныеДанныеЛиста, НомерЛиста, СведенияОбОП, , КоличЗаполненных);
		...
		КонецЕсли;
		КоличЗаполненных = 0;
		ПроверитьЗаполнениеТаблицыРаздел2(СтатусПроверки, мИдГруппы22, ДанныеДопСтрок, ДополнительныеДанныеЛиста, НомерЛиста, СведенияОбОП, ЕстьЗаполненныеСтроки, КоличЗаполненных);
