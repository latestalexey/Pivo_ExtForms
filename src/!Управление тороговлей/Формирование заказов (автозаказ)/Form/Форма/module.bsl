...
#КонецОбласти
	...
	//|	МатрицаТорговойТочкиСрезПоследних.Номенклатура.ОсновнойПоставщик КАК Поставщик1,
	//|	МатрицаТорговойТочкиСрезПоследних.Номенклатура.Поставщик2 КАК Поставщик2,
	...
	//|ГДЕ
	//|	ВЫБОР
	//|			КОГДА &КлассТорговойТочки = ЗНАЧЕНИЕ(Справочник.КлассыТорговойТочки.ПустаяСсылка)
	//|				ТОГДА ИСТИНА
	//|			ИНАЧЕ МатрицаТорговойТочкиСрезПоследних.КлассТорговойТочки = &КлассТорговойТочки
	//|		КОНЕЦ
	//|	И ВЫБОР
	...
	//|				ТОГДА ИСТИНА
	//|			ИНАЧЕ МатрицаТорговойТочкиСрезПоследних.Номенклатура.НоменклатурнаяГруппа = &НоменклатурнаяГруппа
	//|		КОНЕЦ
	//|	И ВЫБОР
	//|			КОГДА &Поставщик = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	//|				ТОГДА ИСТИНА
	//|			ИНАЧЕ МатрицаТорговойТочкиСрезПоследних.Номенклатура.ОсновнойПоставщик = &Поставщик
	//|					ИЛИ МатрицаТорговойТочкиСрезПоследних.Номенклатура.Поставщик2 = &Поставщик
	//|		КОНЕЦ
	//|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	//|	МатрицаТочки.Поставщик1,
	//|	МатрицаТочки.Поставщик2,
...
Процедура ПриОткрытии()
	ПостроительМатрицыТочки.Текст="ВЫБРАТЬ
	                              ...
	                              |		КОНЕЦ) КАК Поставщик}";
	ПостроительМатрицыТочки.Выполнить();
	ПостроительМатрицыТочки.Отбор.Добавить("КлассТорговойТочки");
	ПостроительМатрицыТочки.Отбор.Добавить("Склад");
	ПостроительМатрицыТочки.Отбор.Добавить("НоменклатурнаяГруппа");
