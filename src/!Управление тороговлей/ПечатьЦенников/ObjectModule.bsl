...
Функция ПечатьЦенника() Экспорт
	...
	ЕдКГ=Справочники.КлассификаторЕдиницИзмерения.НайтиПоКоду("166");
	Для Каждого СтрокаТаблицы Из Товары Цикл
		Если СтрокаТаблицы.Печать Тогда
			Для Тмп = 1 По СтрокаТаблицы.Количество Цикл
				...
				КонецЕсли;
				Если ПреобразовыватьВес и СтрокаТаблицы.ЕдиницаИзмерения.ЕдиницаПоКлассификатору=ЕдКГ Тогда
					ОбластьЦенника.Параметры.НоменклатураНаименование=ОбластьЦенника.Параметры.НоменклатураНаименование+" (100 гр.)";
				КонецЕсли;
				...
				Если не ВыводитьШтрихкод Тогда
					...
					Если ПреобразовыватьВес и СтрокаТаблицы.ЕдиницаИзмерения.ЕдиницаПоКлассификатору=ЕдКГ Тогда
						ОбластьЦенника.Параметры.ЕдиницаНаименование         = "г.";
					КонецЕсли;
				КонецЕсли;
				ОбластьЦенника.Параметры.Цена                            = ОбщегоНазначения.ФорматСумм(СтрокаТаблицы.Цена*?(ПреобразовыватьВес и СтрокаТаблицы.ЕдиницаИзмерения.ЕдиницаПоКлассификатору=ЕдКГ,0.1,1), Валюта, "00");
