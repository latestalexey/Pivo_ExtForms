...
Процедура КнопкаВыполнитьНажатие(Кнопка)
	...
	Пока ВыборкаВерсийПоДокументам.Следующий() Цикл
		...
		Пока ВыборкаВерсий.Следующий() Цикл
			Таб2=ТабТемп.Скопировать(ТабТемп.НайтиСтроки(Новый Структура("Документ,НомерВерсии",ВыборкаВерсийПоДокументам.Документ,ВыборкаВерсий.НомерВерсии)),"Номенклатура,Количество,Комментарий");
