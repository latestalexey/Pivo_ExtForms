...
Процедура ККМOfflineВыбор(Элемент, ЭлементСписка)
	...
	Иначе
		...
		Товары=ИТИМодуль_ВыгрузкаДанныхВКассы.ПолучитьТаблицуТоваровДляВыгрузки();
		...
		ТоварыВыгрузка=ИТИМодуль_ВыгрузкаДанныхВКассы.ПодготовитьТаблицуКВыгрузке(Товары,Склад,ККМOffline,АкционныйТоварБезЦен);
...
//ZAM+++ 22.05.13 #1046904 Сделать загрузку товаров во все кассы по одной кнопке
	...
	ТоварыКВыгрузке=ИТИМодуль_ВыгрузкаДанныхВКассы.ПолучитьТаблицуТоваровДляВыгрузки();
	...
	Для Каждого Элемент Из СпККМOffline Цикл
		...
		Товары=ИТИМодуль_ВыгрузкаДанныхВКассы.ПодготовитьТаблицуКВыгрузке(ТоварыКВыгрузке,Элемент.Значение.Склад,КассаККМ,АкционныйТоварБезЦен);
