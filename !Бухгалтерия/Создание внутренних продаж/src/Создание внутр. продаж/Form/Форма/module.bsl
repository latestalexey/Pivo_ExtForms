...
#КонецОбласти
	...
	КонецЕсли;
	мИспользоватьОтветХранение=Константы.ИспользоватьОтветственноеХранение.Получить();
...
#Область Внутренние_продажи		
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			ТаблицаДанныхДляДокументов=ВнутренниеПродажи(ВыборкаДетальныеЗаписи.Ссылка);
			СоздатьДокументыВнутрПродажи(ВыборкаДетальныеЗаписи.Ссылка.ПолучитьОбъект(),ТаблицаДанныхДляДокументов);
