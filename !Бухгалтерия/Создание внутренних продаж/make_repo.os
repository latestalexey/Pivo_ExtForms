...
Функция ПолучитьПараметры()
    ...
    Precommit.Вставить("Путь", "C:\Users\krapivin\Documents\tools\Precommit1c"); // <--
    ...
    Пользователь.Вставить("Имя", "krapivin"); // <--
    Пользователь.Вставить("Email", "a.krapivin@otdelit.ru"); // <--
